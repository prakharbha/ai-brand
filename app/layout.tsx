            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-8">
              ...
              <div className="flex flex-col items-start space-y-1.5">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-2">
                  <a href="tel:+919919977300" className="flex items-center gap-1.5 text-xs text-zinc-500 hover:text-brand-orange transition-colors">
                ...
                {/* Registered Office */}
                <div className="flex items-start gap-1.5 pt-2 text-xs text-zinc-500">
                  ...
                  <span>
                    ...
                    L180100, 7th Avenue, Gaur City 1, Gautam Buddha Nagar, Uttar Pradesh – 201318
                  </span>
                </div>
              </div>
